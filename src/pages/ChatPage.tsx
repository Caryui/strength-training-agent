...
import { Model, Session, PermissionMode, CustomAgent, PermissionRequest, UserProfile } from '../types';
import { NewChatView, GeneratePlanOptions } from '../components/NewChatView';
...
export function ChatPage({
  ...
  // 快捷操作：基于已填写的个人档案，调用离线生成器生成 / 调整计划
  const handleGeneratePlan = useCallback((opts: GeneratePlanOptions) => {
    onGeneratePlan(opts);
  }, [onGeneratePlan]);
